      ...
      { !game
        ...
        ? (
          <div className="inputs">
            <Input count={n} increment={1} setCount={setN} text="heigth" />
            <Input count={m} increment={1} setCount={setM} text="width" />
            <Input count={k} increment={10} setCount={setK} text="bombs" />
          </div>
        )
        ...
        : (
          <button
            ...
            onClick={() => {
              ...
              setFieldAns(makeField(n, m, k)); setGame(true);
            }}
          >
            START
          </button>
